...
def display_msg(msg, color):
    ...
    screen.blit(mesg, [screen_width / 6, screen_height / 2.5])
...
def game_start():
    ...
    while not restart:
        ...
        if snake.head_x >= screen_width or snake.head_x < 0 or snake.head_y >= screen_height or snake.head_y < 0:
            finished = True
